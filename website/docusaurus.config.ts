...
if (isSlower) {
  console.log('🐢 Using slower apis build');
}
  ...
  i18n: {
      ...
      [
        'content-docs',
        {
          ...
          editUrl: ({locale, versionDocsDirPath, docPath}) => {
            ...
            return `https://github.com/hyaliyun/apis/edit/main/website/${versionDocsDirPath}/${docPath}`;
          },
        ...
        'classic',
        {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/hyaliyun/apis/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
              ...
              description:
                'apis',
              copyright: `Copyright © ${new Date().getFullYear()} apis, Inc.`,
              xslt: true,
            },
            blogTitle: ' blog',
          ...
          pages: {
            ...
            editUrl: ({locale, pagesPath}) => {
              ...
              return `https://github.com/hyaliyun/apis/edit/main/website/src/pages/${pagesPath}`;
            },
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
    ...
    themeConfig: {
        ...
        items: [
          {
            ...
            activeBaseRegex: `/fo/`,
            items: [
              { label: 'ipstack', to: '/fo/0' },
              { label: 'zenserp', to: '/fo/1' },
              { label: 'zenscrape', to: '/fo/2' },
              { label: 'Fixer API', to: '/fo/3' },
              { label: 'aviationstack', to: '/fo/4' }, 
              { label: 'number_verification', to: '/fo/5' },  
              { label: 'exchangerates_data', to: '/fo/6' },         
              { label: 'marketstack', to: '/fo/7' },  
              { label: 'positionstack', to: '/fo/8' },  
              { label: 'weatherstack', to: '/fo/9' },  
              { label: 'youtube', to: '/fo/10' },  

              { label: 'sentiment', to: '/fo/11' },  
              { label: 'currency_data', to: '/fo/12' },  
              { label: 'adv_scraper', to: '/fo/13' },  
              { label: 'filestack', to: '/fo/14' },  
              { label: 'exchangerate_host', to: '/fo/15' },  
              { label: 'vatlayer', to: '/fo/16' },  
              { label: 'coinlayer', to: '/fo/17' },  
              { label: 'bincheck', to: '/fo/18' },  
              { label: 'short_url', to: '/fo/19' },  
              { label: 'bad_words', to: '/fo/20' },  
              { label: 'email_verification', to: '/fo/21' },  
              { label: 'image_to_text', to: '/fo/22' },  
              { label: 'domain_discovery', to: '/fo/23' },  
              { label: 'user_agent', to: '/fo/24' },  
              { label: 'bank_data', to: '/fo/25' },  
              { label: 'world_news', to: '/fo/26' },  
              { label: 'TheRundown', to: '/fo/27' },
              { label: 'picwish', to: '/fo/28' },
            ]
          },
          ...
          {to: 'MapComponent', label: 'Map', position: 'left'},
          ...
          {
            href: 'https://github.com/hyaliyun/apis',
            position: 'right',
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} apis`,
      },
