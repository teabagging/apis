...
On top of the object store, optional [Filer][Filer] can support directories and POSIX attributes.
...
* [WebDAV][WebDAV] accesses as a mapped drive on Mac and Windows, or from mobile devices.
