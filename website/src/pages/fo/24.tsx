	...
	return (
	  <div className={styles.topBanner}>
		<div className={styles.topBannerTitle}>
		  {'🎉\xa0'}
		  <Link
			to={`https://apilayer.com/marketplace/user_agent-api`}
		...
		<div className={styles.heroInner}>
		  <Heading as="h1" className={styles.heroProjectTagline}>
			<img
			  alt={translate({message: 'Docusaurus with Keytar'})}
			  className={styles.heroLogo}
			  src={useBaseUrl('/assets/images/user_agent.png')}
			  width="200"
			  height="200"
			/>
			<span
			  ...
			  dangerouslySetInnerHTML={{
				__html: translate({
				  ...
				  message:
					'Detect any browser,  <b></b>device & OS from user agent strings and generate new ones randomly.',
				  description:
		  ...
		  <div className={styles.indexCtas}>
			<Link className="button button--primary" to="https://apilayer.com/marketplace/user_agent-api">
			  <Translate>Get Started</Translate>
			</Link>
			<Link className="button button--info" to="https://apilayer.com/marketplace/user_agent-api">
