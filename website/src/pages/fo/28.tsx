	...
	return (
	  <div className={styles.topBanner}>
		<div className={styles.topBannerTitle}>
		  {'🎉\xa0'}
		  <Link
			to={`https://apilayer.com/marketplace/picwish-api`}
		...
		<div className={styles.heroInner}>
		  <Heading as="h1" className={styles.heroProjectTagline}>
			<img
			  alt={translate({message: 'Docusaurus with Keytar'})}
			  className={styles.heroLogo}
			  src={useBaseUrl('/assets/images/picwish.png')}
			  width="200"
			  height="200"
			/>
			<span
			  ...
			  dangerouslySetInnerHTML={{
				__html: translate({
				  ...
				  message:
					'PicWish Background <b>Website</b>Removal API',
				  description:
		  ...
		  <div className={styles.indexCtas}>
			<Link className="button button--primary" to="https://apilayer.com/marketplace/picwish-api">
			  <Translate>Get Started</Translate>
			</Link>
			<Link className="button button--info" to="https://apilayer.com/marketplace/picwish-api">
