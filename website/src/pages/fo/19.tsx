	...
	return (
	  <div className={styles.topBanner}>
		<div className={styles.topBannerTitle}>
		  {'🎉\xa0'}
		  <Link
			to={`https://apilayer.com/marketplace/short_url-api`}
		...
		<div className={styles.heroInner}>
		  <Heading as="h1" className={styles.heroProjectTagline}>
			<img
			  alt={translate({message: 'Docusaurus with Keytar'})}
			  className={styles.heroLogo}
			  src={useBaseUrl('/assets/images/short_url.png')}
			  width="200"
			  height="200"
			/>
			<span
			  ...
			  dangerouslySetInnerHTML={{
				__html: translate({
				  ...
				  message:
					'URL Shortener service <b>with</b>  an API which provides extensive analytics backend',
				  description:
		  ...
		  <div className={styles.indexCtas}>
			<Link className="button button--primary" to="https://apilayer.com/marketplace/short_url-api">
			  <Translate>Get Started</Translate>
			</Link>
			<Link className="button button--info" to="https://apilayer.com/marketplace/short_url-api">
